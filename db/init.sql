...
-- Clear existing data to prevent duplicates when running this script multiple times
...
'EASY',
E'public static int[] twoSum(int[] nums, int target) {\n    // Write your solution here\n    \n    return new int[]{};\n}',
...
'EASY',
E'public static String reverseString(String s) {\n    // Write your solution here\n    \n    return "";\n}',
